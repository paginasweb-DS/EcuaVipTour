...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public void addInterceptors(List<EndpointInterceptor> interceptors) {
        ...
        validatingInterceptor.setSchemas(new Resource[]{
                new ClassPathResource("xsd/auth.xsd"),
                new ClassPathResource("xsd/viajes.xsd"),
                new ClassPathResource("xsd/chat.xsd"),
                new ClassPathResource("xsd/chofer.xsd"),
                new ClassPathResource("xsd/pagos.xsd"),
                new ClassPathResource("xsd/admin.xsd")
        });
        try {
    ...
    public XsdSchema viajesSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/viajes.xsd"));
    }
    ...
    public XsdSchema choferSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/chofer.xsd"));
    }
    ...
    public XsdSchema adminSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/admin.xsd"));
    }
}
